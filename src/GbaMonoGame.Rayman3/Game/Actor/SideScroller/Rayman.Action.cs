...
public partial class Rayman
{
    ...
    public enum Action
    {
        ...
        Dying_Right = 158,
        Dying_Left = 159,
        WalkingShell_Ride = 160,
        WalkingShell_Boost = 161,
        WalkingShell_Jump = 162,
        WalkingShell_Loop = 163,
        WalkingShell_EndBoost = 164,
        WalkingShell_BeginBoost = 165,
        WalkingShell_Mount = 166,
